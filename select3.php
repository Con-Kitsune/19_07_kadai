...
//２．データ登録SQL作成
$stmt = $pdo->prepare("SELECT * FROM gs_bm_tabel WHERE Session='Q1' ORDER BY laptime ASC;");
$status = $stmt->execute();
...
<header>
  <nav class="navbar navbar-default">
    <div class="container-fluid">
      ...
      <a class="navbar-brand" href="index.php?source=P1">データ登録</a>
      <a class="navbar-brand" href="select.php?source=P1">manufacturer別</a>
      <a class="navbar-brand" href="select4.php?source=P1">P2</a>
      ...
      <a class="navbar-brand" href="select5.php?source=P1">Graf</a>
    <a class="navbar-brand" href="select6.php?source=P1">Refarrer(疑似Google Analytics)</a></div>
      </div>
    </div>
  </nav>
</header>
